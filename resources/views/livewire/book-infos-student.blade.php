            ...
            <td colspan="3" class="book__info__cell">
                <div class="book__info">
                    ...
                    <dl class="book__info__about">
                        ...
                        <dd class="book__def book__info__def">@foreach($book->authors as $author)<p>{{$author->name}}</p> @endforeach</dd>
                    ...
                    <dl class="book__info__more">
                        ...
                        <dd class="more__def book__info__more__def">{{$book->textualContent->text}}
                        </dd>
                    </dl>
                    <div class="form__control--inline">
                        <div class="quantity__container">
                            ...
                            <input  class="quantity__input" type="number" name="quantity" id="quantity" @if(count($book->orders)>0)value="{{$book->orders[0]->pivot->quantity}}" @else value=0 @endif>
                        </div>
                            <button
                            class="btn end__btn--half"
                            type="submit">Ajouter à la commande
                        </button>
                    </div>
                </div>
            </td>
